...
import com.daogj.web.util.ThreadLoggingAppender;
...
public class AsynPrintLogsInRequestFilter implements Filter {
    ...
    ThreadLoggingAppender myAppender = null;
    
    public void init(FilterConfig arg0) throws ServletException {
    	
    	myAppender = ThreadLoggingAppender.findThreadLoggingAppenderFromRootLogger();
